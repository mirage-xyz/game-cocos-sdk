...
var typedarrayToBuffer = function typedarrayToBuffer (arr) {
  if (isTypedArray(arr)) {
    ...
    var buf = require$$2.Buffer.from(arr.buffer);
    ...
    return require$$2.Buffer.from(arr)
  }
};
...
function hexToBuffer(hex) {
    return require$$2.Buffer.from(removeHexPrefix(hex), ENC_HEX);
}
function hexToArray(hex) {
    return bufferToArray(hexToBuffer(hex));
}
function utf8ToBuffer(utf8) {
    return require$$2.Buffer.from(utf8, ENC_UTF8);
}
...
const WS = typeof window.WebSocket !== "undefined" ? window.WebSocket : require("ws");
